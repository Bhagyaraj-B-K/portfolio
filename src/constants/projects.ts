export default {
  Korus: {
    ...
    I enabled the minting of music assets through web3 technologies using Mintfactory APIs and streamlined the user experience by integrating invisible wallet creation via ThirdWeb. Utilized technologies such as NestJs, DynamoDB, MySQL, Redis, Jest for testing, and Bitbucket for repository management and CICD pipelines. The servers were deployed using Render.`,
