        ...
        <div className="col-md-12">
          ...
          <div className="row">
            ...
            <div className='col-md-6' style={{textAlign: 'right'}}>
              ...
              <p style={{color: '#D39B44', fontSize: '18px', paddingTop: '40px', fontStyle: 'bold', marginLeft: '40px', lineHeight: '20px'}}>
                Working as <br /> 
                A {bio.currentCompany.designation}
              </p>
              ...
              <p style={{color: '#D39B44', marginTop: '60px', lineHeight: '20px'}}>
                <span style={{fontSize: '60px', fontStyle: 'italic'}}>{`${bio.getTotalExperience.years}.${bio.getTotalExperience.months}`}</span>Yrs <br />
                of Professional <br />
                Experience
              </p>
            </div>
